...
;	interaction species     type-incl     type-excl landmark                 mapid                    time       status      event                        script
	interaction -1,         -1,           -1,       -1,                      -1,                       -1,       SLP,        -1,                          SleepInteraction
	...
	interaction PICHU,      -1,           -1,       LANDMARK_ECRUTEAK_CITY,  MAP_DANCE_THEATRE,        -1,       -1,         -1,                          DanceTheaterPichuInteraction
	interaction BELLOSSOM,  -1,           -1,       LANDMARK_ECRUTEAK_CITY,  MAP_DANCE_THEATRE,        -1,       -1,         -1,                          DanceTheaterBellossomInteraction
